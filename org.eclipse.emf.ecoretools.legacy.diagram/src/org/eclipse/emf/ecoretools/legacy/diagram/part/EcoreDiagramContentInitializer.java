...
public class EcoreDiagramContentInitializer {
	...
	public void initDiagramContent(Diagram diagram) {
		if (!EPackageEditPart.MODEL_ID.equals(diagram.getType())) {
			EcoreDiagramEditorPlugin.getInstance().logError(org.eclipse.emf.ecoretools.legacy.diagram.Messages.EcoreDiagramContentInitializer_IncorrectDiagramAsParameter + diagram.getType());
			return;
		}
		if (false == diagram.getElement() instanceof EPackage) {
			EcoreDiagramEditorPlugin.getInstance().logError(NLS.bind(org.eclipse.emf.ecoretools.legacy.diagram.Messages.EcoreDiagramContentInitializer_IncorrectElementSpecified, diagram.getElement()));
			return;
		}
