...
package org.eclipse.emf.ecoretools.legacy.diagram.part;
...
public class EcorePaletteFactory {
	...
	private ToolEntry createEPackage1CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EPackage.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EPackage_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEClass2CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EClass.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EClass_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEDataType3CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EDataType.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EDataType_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEEnum4CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EEnum.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EEnum_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEAnnotation5CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EAnnotation.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EAnnotation_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEOperation7CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EOperation.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EOperation_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEAttribute8CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EAttribute.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EAttribute_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEEnumLiteral9CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EEnumLiteral.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EEnumLiteral_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createDetailsEntry10CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EStringToStringMapEntry.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EStringToStringMapEntry_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEReference1CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EReference.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/EReference_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createInheritance2CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/Inheritance.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/Inheritance_24.gif")); //$NON-NLS-1$
		return entry;
	}
	...
	private ToolEntry createEAnnotationlink3CreationTool() {
		...
		entry.setSmallIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/AnnotationLink.gif")); //$NON-NLS-1$
		entry.setLargeIcon(EcoreDiagramEditorPlugin.findImageDescriptor("/org.eclipse.emf.ecoretools.legacy.diagram/icons/AnnotationLink_24.gif")); //$NON-NLS-1$
		return entry;
	}
