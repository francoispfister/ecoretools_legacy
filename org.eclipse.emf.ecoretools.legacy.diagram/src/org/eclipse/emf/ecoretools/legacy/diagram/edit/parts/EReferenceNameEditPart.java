...
public class EReferenceNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(EcoreVisualIDRegistry.getType(org.eclipse.emf.ecoretools.legacy.diagram.edit.parts.EReferenceNameEditPart.VISUAL_ID), new Point(-10, -10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EReference_3002, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.legacy.diagram.edit.parts.EReferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
