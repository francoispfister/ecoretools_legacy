	...
	public boolean performFinish() {
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				...
				EcoreDiagramEditorPlugin.getInstance().logError(org.eclipse.emf.ecoretools.legacy.diagram.Messages.EcoreCreationWizard_ErrorOnCreation, e.getTargetException());
			}
			return false;
		}
		return diagram != null;
