...
public class EReferenceLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(EcoreVisualIDRegistry.getType(org.eclipse.emf.ecoretools.legacy.diagram.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID), new Point(10, 10));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EReference_3002, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.legacy.diagram.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
	}
