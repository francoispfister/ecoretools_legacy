...
import org.eclipse.emf.ecoretools.legacy.diagram.edit.policies.EStringToStringMapEntryItemSemanticEditPolicy;
import org.eclipse.emf.ecoretools.legacy.diagram.edit.policies.EcoreTextNonResizableEditPolicy;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EStringToStringMapEntry_2007, getParserElement(), EcoreVisualIDRegistry
					.getType(org.eclipse.emf.ecoretools.legacy.diagram.edit.parts.EStringToStringMapEntryEditPart.VISUAL_ID));
		}
		return parser;
	}
